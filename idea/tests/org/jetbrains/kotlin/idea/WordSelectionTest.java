...
public class WordSelectionTest extends KotlinLightCodeInsightFixtureTestCase {
    ...
    public void testValueParametersInLambda() {
        doTest();
    }
    ...
    public void testDocCommentOneLine() {
        doTest();
    }

    public void testDocCommentTagName() {
        doTest();
    }

    public void testDocCommentTagText() {
        doTest();
    }

    public void testDocCommentTagLink() {
        doTest();
    }

    public void testFunctionWithLineCommentBefore() {
        doTest();
    }

    public void testFunctionWithLineCommentAfter() {
        doTest();
    }
    ...
    public void testIfBody() {
        doTest();
    }

    public void testCommentForStatements() {
        doTest();
    }

    public void testCommentForStatementsInLambda() {
        doTest();
    }
    ...
    public void testSimpleStringLiteral2() {
        doTest();
    }

    public void testTemplateStringLiteral1() {
        doTest();
    }
    public void testTemplateStringLiteral2() {
        doTest();
    }
    public void testTemplateStringLiteral3() {
        doTest();
    }
    ...
    public void testDefiningVariable() {
        doTest();
    }
    ...
    public void testDeclarationWithComment4() {
        doTest();
    }
    ...
    public void testClassMember4() {
        doTest();
    }
    public void testClassMember5() {
        doTest();
    }
